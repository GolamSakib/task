                                ...
                                <form action="{{ route('admin.products.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" value="{{old('price')}}" type="number" id="html5-text-input"
                                                    name="price">
                                            </div>
                                            <div>
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" value="{{old('quantity')}}" type="number" id="html5-text-input"
                                                    name="quantity">
                                            </div>
                                            <div class="col-md-2">
